              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table id="myTable" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <tr v-for="(jurnal, index) in izins" :key="index.id">
...
export default {
  ...
  methods: {
    ...
    showModalEdit(izin) {
      ...
      $("#modalmuncul").modal("show");
      this.getAbsensiById(izin);
    },
    getdata() {
      this.$Progress.start();
      IzinService.getIzin()
        .then((response) => {
          this.izins = response.data;
          $(function () {
            $("#myTable")
              .DataTable({
                responsive: false,
    ...
    simpanData() {
      ...
      this.loading = true;
      this.disabled = true;
      IzinService.createIzin(this.form)
        .then((response) => {
    ...
    updateData() {
      ...
      this.loading = true;
      this.disabled = true;
      IzinService.updateIzin(this.form.id, this.form)
        .then((response) => {
          this.from = response.data;
          console.log(response.data);
          this.getdata();
